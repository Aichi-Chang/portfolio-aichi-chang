...
export default function Fact() {
  ...
  return (
   ...
   <p className='avenir'>
     Hello, I'm Aichi. A junior software developer - enjoy reading manga, eating french dessert, and watching indie films <span role='img' aria-label='sunglasses'>😎</span>
   </p>
   ...
   {expand.two === true && <p id='2' className='avenir'>Design and coding are very similar to me as they both require creativities to solve problems</p>}
   {expand.three === true && <p id='3' className='avenir'>Being a software engineer has perfectly combined my problem-solving skills, desire of learning new things, and knowledge in software engineering <span role='img' aria-label='star'>💫</span></p>}
